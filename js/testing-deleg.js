...
элемент, используется метод event.targer.closest(название дочернего элемента, которыйнужен))
